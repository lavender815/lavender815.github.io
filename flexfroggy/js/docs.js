<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\assets\css\APlayer.min.css"><script src="\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script><script class="meting-secondary-script-marker" src="\assets\js\Meting.min.js"></script>var docs = {
  'align-content': {
    ...
    'th': '<p>จัดวางแนวของ flex container ภายใน flex container เมื่อมีพื้นที่เพิ่มเติมบนแกนไขว้.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>space-evenly</code> <code>stretch (default)</code>',
  ...
  'justify-content': {
    ...
    'th': '<p>จัดวาง flex item ตามแนวแกนหลัก.</p><code>flex-start (default)</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>space-evenly</code>',
